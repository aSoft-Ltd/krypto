import krypto.encoding.ASCII
import krypto.SHA256
import krypto.hash
import krypto.sha256
...
class SHA256Test {
    ...
    fun test2() {
        ...
        assertEquals("ffe054fe7ae0cb6dc65c3af9b61d5209f439851db43d0ba5997337df154668eb", ByteArray(64) { 'a'.toByte() }.hash(
            SHA256
        ).hex)
